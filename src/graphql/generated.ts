...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', id: string, title: string, lessonType: LessonType, availableAt?: any | null, slug?: string | null }> };
